...
The `Console` interface defines log printing methods. Currently, logs are only available in the [backend logs](https://docs.caido.io/reference/configuration/data_location.html).
