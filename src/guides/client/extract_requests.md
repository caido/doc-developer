...
To narrow the list, chain `.filter()` with an [HTTPQL](https://docs.caido.io/reference/httpql.html) query string. The same syntax used in the Caido HTTP History UI works here:
